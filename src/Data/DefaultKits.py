...
_TTABS_COM_DRUMS = [(("Bass drum", "B", "o", True), 36, "normal", -3, STEM_DOWN),
                    (("Floor Tom", "FT", "o", False), 43, "normal", -1, STEM_DOWN),
                    (("Mid Tom", "T", "o", False), 47, "normal", 2, STEM_DOWN),
                    (("Snare", "S", "o", True), 38, "normal", 1, STEM_DOWN),
                    (("Hi-Hat with foot", "Hf", "x", False), 44, "normal", -5, STEM_DOWN),
                    (("HiHat", "HH", "x", False), 42, "normal", 5, STEM_UP),
                    (("Ride Cymbal", "Rd", "x", False), 51, "normal", 4, STEM_UP),
                    (("Crash-ride cymbal", "CR", "x", False), 57, "normal", 7, STEM_UP),
                    (("Crash cymbal", "CC", "x", False), 49, "normal", 6, STEM_UP)]
...
_MVK_DRUMS = [(("Hihat w/foot", "Hf", "o", False), 44, "normal", -5, STEM_DOWN),
