...
_DRUMTABBER_COM_DRUMS = [(("High hat foot", "Hf", "x", False), 44, "cross", -5, STEM_DOWN),
                         (("Bass Drum 2", "B2", "o", False),
                          36, "default", -4, STEM_DOWN),
                         (("Bass Drum 1", "B1", "o", True),
                          35, "default", -3, STEM_DOWN),
                         (("Snare Drum", "SD", "o", True),
                          38, "default", 1, STEM_DOWN),
                         (("Floor Tom 2", "F2", "o", False),
                          41, "default", -2, STEM_DOWN),
                         (("Floor Tom 1", "F1", "o", False),
                          43, "default", -1, STEM_DOWN),
                         (("Tom 4", "T4", "o", False), 45, "default", 2, STEM_UP),
                         (("Tom 3", "T3", "o", False), 47, "default", 3, STEM_UP),
                         (("Tom 2", "T2", "o", False), 48, "default", 4, STEM_UP),
                         (("Tom 1", "T1", "o", False), 50, "default", 5, STEM_UP),
                         (("Hihat", "HH", "x", False), 42, "cross", 5, STEM_UP),
                         (("Ride Cymbal", "Rd", "x", False),
                          51, "cross", 4, STEM_UP),
                         (("Crash Cymbal 2", "C2", "x", False),
                          57, "cross", 7, STEM_UP),
...
_DRUMTABBER_COM_KIT = {"drums": _DRUMTABBER_COM_DRUMS,
                       "heads": _DRUMTABBER_COM_HEADS}
