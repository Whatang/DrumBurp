...
#
# Created: Sun Sep 25 11:36:45 2011
...
class Ui_editKitDialog(object):
    def setupUi(self, editKitDialog):
        ...
        self.noteHeadTable.setProperty(_fromUtf8("showDropIndicator"), False)
        ...
        spacerItem7 = QtGui.QSpacerItem(13, 17, QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Minimum)
        ...
        spacerItem9 = QtGui.QSpacerItem(20, 19, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, editKitDialog):
        ...
        self.deleteEmptyButton.setStatusTip(QtGui.QApplication.translate("editKitDialog", "Delete empty non-locked drums", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.muteButton.setToolTip(QtGui.QApplication.translate("editKitDialog", "Mute audio", None, QtGui.QApplication.UnicodeUTF8))
