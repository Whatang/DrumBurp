...
#
# Created: Sun Apr 17 15:42:37 2011
...
class Ui_DrumBurpWindow(object):
    def setupUi(self, DrumBurpWindow):
        ...
        DrumBurpWindow.setTabOrder(self.metadataFontSizeSpinbox, self.lineSpaceSlider)
        DrumBurpWindow.setTabOrder(self.lineSpaceSlider, self.beatsSpinBox)
        DrumBurpWindow.setTabOrder(self.beatsSpinBox, self.beatCountComboBox)
        DrumBurpWindow.setTabOrder(self.beatCountComboBox, self.widthSpinBox)
        DrumBurpWindow.setTabOrder(self.widthSpinBox, self.fitPageButton)
        DrumBurpWindow.setTabOrder(self.fitPageButton, self.fitWindowButton)
        DrumBurpWindow.setTabOrder(self.fitWindowButton, self.scoreView)
