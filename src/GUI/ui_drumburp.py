...
#
# Created: Sun Apr 17 13:03:35 2011
...
class Ui_DrumBurpWindow(object):
    def setupUi(self, DrumBurpWindow):
        ...
        sizePolicy.setHeightForWidth(self.noteHeadDock.sizePolicy().hasHeightForWidth())
        self.noteHeadDock.setSizePolicy(sizePolicy)
        ...
        self.gridLayout.addWidget(self.bigXNoteHeadButton, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.oNoteHeadButton, 3, 1, 1, 1)
        ...
        self.songPropertiesDock.setFloating(False)
        ...
        self.lineSpaceSlider = QtGui.QSlider(self.groupBox_3)
        ...
        self.horizontalLayout_2.addWidget(self.lineSpaceSlider)
        ...
        self.beatsSpinBox = QtGui.QSpinBox(self.groupBox)
        ...
        self.gridLayout_4.addWidget(self.beatsSpinBox, 0, 1, 1, 1)
        self.label_5 = QtGui.QLabel(self.groupBox)
        self.label_5.setObjectName(_fromUtf8("label_5"))
        self.gridLayout_4.addWidget(self.label_5, 1, 0, 1, 1)
        self.beatCountComboBox = QtGui.QComboBox(self.groupBox)
        self.beatCountComboBox.setMaxCount(20)
        self.beatCountComboBox.setObjectName(_fromUtf8("beatCountComboBox"))
        self.gridLayout_4.addWidget(self.beatCountComboBox, 1, 1, 1, 1)
        ...
        self.widthSpinBox = QtGui.QSpinBox(self.groupBox_2)
        ...
        self.fitPageButton = QtGui.QPushButton(self.groupBox_2)
        icon2 = QtGui.QIcon()
        ...
        self.verticalLayout_3.addWidget(self.fitPageButton)
        self.fitWindowButton = QtGui.QPushButton(self.groupBox_2)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/Icons/Icons/video-display.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.fitWindowButton.setIcon(icon3)
        self.fitWindowButton.setObjectName(_fromUtf8("fitWindowButton"))
        self.verticalLayout_3.addWidget(self.fitWindowButton)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/Icons/Icons/system-log-out.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionQuit.setIcon(icon4)
        self.actionQuit.setObjectName(_fromUtf8("actionQuit"))
        self.actionNew = QtGui.QAction(DrumBurpWindow)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/Icons/Icons/document-new.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionNew.setIcon(icon5)
        self.actionNew.setObjectName(_fromUtf8("actionNew"))
        self.actionLoad = QtGui.QAction(DrumBurpWindow)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/Icons/Icons/document-open.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionLoad.setIcon(icon6)
        self.actionLoad.setObjectName(_fromUtf8("actionLoad"))
        self.actionSave = QtGui.QAction(DrumBurpWindow)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/Icons/Icons/document-save.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSave.setIcon(icon7)
        self.actionSave.setObjectName(_fromUtf8("actionSave"))
        self.actionSaveAs = QtGui.QAction(DrumBurpWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8(":/Icons/Icons/document-save-as.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSaveAs.setIcon(icon8)
        self.actionSaveAs.setObjectName(_fromUtf8("actionSaveAs"))
        self.actionExportASCII = QtGui.QAction(DrumBurpWindow)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8(":/Icons/Icons/format-text-bold.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionExportASCII.setIcon(icon9)
        ...
        self.actionFitInWindow.setIcon(icon3)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(_fromUtf8(":/Icons/Icons/document-print.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionPrint.setIcon(icon10)
        self.actionPrint.setObjectName(_fromUtf8("actionPrint"))
        self.actionWhatsThis = QtGui.QAction(DrumBurpWindow)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(_fromUtf8(":/Icons/Icons/help-browser.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionWhatsThis.setIcon(icon11)
        self.actionWhatsThis.setObjectName(_fromUtf8("actionWhatsThis"))
        self.actionUndo = QtGui.QAction(DrumBurpWindow)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(_fromUtf8(":/Icons/Icons/edit-undo.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionUndo.setIcon(icon12)
        self.actionUndo.setObjectName(_fromUtf8("actionUndo"))
        self.actionRedo = QtGui.QAction(DrumBurpWindow)
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(_fromUtf8(":/Icons/Icons/edit-redo.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRedo.setIcon(icon13)
        self.actionRedo.setObjectName(_fromUtf8("actionRedo"))
        self.actionExportPDF = QtGui.QAction(DrumBurpWindow)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(_fromUtf8(":/Icons/Icons/pdf.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(_fromUtf8(":/Icons/Icons/format-justify-fill.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionShowEmptyLines.setIcon(icon15)
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(_fromUtf8(":/Icons/Icons/1299815323_HAL-9000 Brain Room Key.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionShowDrumKey.setIcon(icon16)
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(_fromUtf8(":/Icons/Icons/1299814882_Black_Numbered-List.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionShowBeatCount.setIcon(icon18)
        ...
        DrumBurpWindow.setTabOrder(self.tabberEdit, self.widthSpinBox)
        DrumBurpWindow.setTabOrder(self.widthSpinBox, self.fitWindowButton)
        DrumBurpWindow.setTabOrder(self.fitWindowButton, self.defaultNoteHeadButton)
        DrumBurpWindow.setTabOrder(self.defaultNoteHeadButton, self.xNoteHeadButton)
        DrumBurpWindow.setTabOrder(self.xNoteHeadButton, self.gNoteHeadButton)
        DrumBurpWindow.setTabOrder(self.gNoteHeadButton, self.bigONoteHeadButton)
        DrumBurpWindow.setTabOrder(self.bigONoteHeadButton, self.flamNoteTeller)
        DrumBurpWindow.setTabOrder(self.flamNoteTeller, self.scoreView)
    ...
    def retranslateUi(self, DrumBurpWindow):
        ...
        self.groupBox.setTitle(QtGui.QApplication.translate("DrumBurpWindow", "Default Measure Options", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.groupBox_2.setTitle(QtGui.QApplication.translate("DrumBurpWindow", "Score Width", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.fitPageButton.setToolTip(QtGui.QApplication.translate("DrumBurpWindow", "Fit Score to Page", None, QtGui.QApplication.UnicodeUTF8))
        self.fitPageButton.setStatusTip(QtGui.QApplication.translate("DrumBurpWindow", "Attempt to make the score as wide as possible within a standard page", None, QtGui.QApplication.UnicodeUTF8))
        self.fitPageButton.setText(QtGui.QApplication.translate("DrumBurpWindow", "Fit Page", None, QtGui.QApplication.UnicodeUTF8))
