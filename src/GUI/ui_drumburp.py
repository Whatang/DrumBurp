...
#
# Created: Tue Jan 18 20:21:52 2011
...
class Ui_DrumBurpWindow(object):
    def setupUi(self, DrumBurpWindow):
        ...
        self.defaultMeasureWidthSpinBox = QtGui.QSpinBox(self.dockWidgetContents_2)
        self.defaultMeasureWidthSpinBox.setMinimum(1)
        self.defaultMeasureWidthSpinBox.setMaximum(256)
        self.defaultMeasureWidthSpinBox.setProperty(_fromUtf8("value"), 16)
        self.defaultMeasureWidthSpinBox.setObjectName(_fromUtf8("defaultMeasureWidthSpinBox"))
        self.horizontalLayout.addWidget(self.defaultMeasureWidthSpinBox)
        ...
        QtCore.QObject.connect(self.defaultMeasureWidthSpinBox, QtCore.SIGNAL(_fromUtf8("valueChanged(int)")), self.scoreView.setDefaultMeasureWidth)
    ...
    def retranslateUi(self, DrumBurpWindow):
        ...
        self.label_4.setText(QtGui.QApplication.translate("DrumBurpWindow", "Default Measure Width", None, QtGui.QApplication.UnicodeUTF8))
        self.defaultMeasureWidthSpinBox.setToolTip(QtGui.QApplication.translate("DrumBurpWindow", "Default Measure Width", None, QtGui.QApplication.UnicodeUTF8))
        self.defaultMeasureWidthSpinBox.setStatusTip(QtGui.QApplication.translate("DrumBurpWindow", "The number of ticks in default measures added to the Score", None, QtGui.QApplication.UnicodeUTF8))
        self.defaultMeasureWidthSpinBox.setSuffix(QtGui.QApplication.translate("DrumBurpWindow", " ticks", None, QtGui.QApplication.UnicodeUTF8))
