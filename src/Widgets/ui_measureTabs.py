...
class Ui_measureTabs(object):
    ...
    def retranslateUi(self, measureTabs):
        ...
        self.beatsSpinBox.setToolTip(QtGui.QApplication.translate("measureTabs", "The size of each measure in the new score in ticks", None, QtGui.QApplication.UnicodeUTF8))
        self.beatsSpinBox.setStatusTip(QtGui.QApplication.translate("measureTabs", "The size of each measure in the new score in ticks", None, QtGui.QApplication.UnicodeUTF8))
